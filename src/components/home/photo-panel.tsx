 ...
 * restyle-homepage-community-pillars).
 *
 * The device is borrowed from the organisation's predecessor site — a
 * photograph paired with a flat colour panel. The photographs are now shown
 * untreated: the earlier brand-green wash muddied the neighbourhood imagery and
 * was removed (restyle-homepage-community-pillars design D1). Text still lives on
 * the flat colour panel, so its contrast is a property of the token pair, not of
 * the photograph.
 *
